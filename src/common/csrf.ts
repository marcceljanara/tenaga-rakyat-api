...
export const {
  ...
  getSessionIdentifier: (req: Request) => req.cookies?.['refresh_token'] || 'guest',
  ...
  getCsrfTokenFromRequest: (req: Request) => req.headers['x-csrf-token'] as string, // function to get token
});
